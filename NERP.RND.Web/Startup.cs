...
using System.Linq;
using System.Text;
using HomepassService = NERP.Homepasses.HomepassService;
using IHomepassService = NERP.Homepasses.IHomepassService;
...
namespace NERP.RND.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IFatService, FatService>();
            services.AddScoped<IFdtService, FdtService>();
