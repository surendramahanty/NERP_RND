...
export class DesignMap implements OnInit, OnChanges {
                ...
                stop: (e) => {
                    ...
                    if (entityType == "UndergroundCable") {
                        ...
                        GMHelper.addListener(polyline, "rightclick", function (event) {
                            ...
                            cable.code = this.entitiesHelper.generatedCodes('Cable');
                    ...
                    if (entityType == "Overhead Cable") {
                        ...
                        GMHelper.addListener(polyline, "rightclick", function (event) {
                            ...
                            cable.id = Helper.generateObjectId();
                            var ids = cable.id.toString();
                            cable.name = "OverHeadCable_" + ids.substring(0, 3);
                            cable.code = "OverHeadCable_" + ids.substring(0, 3);;
                    ...
                    if (entityType == "Duct") {
                        ...
                        GMHelper.addListener(polyline, "rightclick", function (event) {
                            ...
                            var ids = duct.id.toString();
                            duct.name = "Duct_" + ids.substring(0, 3);
                            duct.code = "Duct_" + ids.substring(0, 3);;
                    ...
                    if (entityType == "Micro Duct") {
                        ...
                        GMHelper.addListener(polyline, "rightclick", function (event) {
                            ...
                            microduct.name = "MicroDuct_" + ids.substring(0, 3);
                            microduct.code = "MicroDuct_" + ids.substring(0, 3);;
                    ...
                    if (entityType == "Pop") {
                        var selectedEntity = this.onEntityTypeChange("Pole");
                        if (seg) {
                            if (seg[0].pops == null) {
    ...
    PlotEntity(value) {
        ...
        if (seg) {
            if (value == 'Splitter') {
                this.onEntityTypeChange("Splitter");
                ...
                if (seg[0].splitters == null) {
                    ...
                    var LastSplitterIndex = this.Data.length - 1;
                    var k = false;
                    if (this.SplitterIncrementalID == 0) {
                        for (var i = 0; i <= 0; i++) {
                            for (var j = 0; j <= i; j++) {
                                if (this.Data[i].segments[j].splitters != undefined || this.Data[i].segments[j].splitters != null) {
                                    var ID1 = this.Data[i].segments[j].splitters.length - 1;
                                    var ID2 = this.Data[i].segments[j].splitters[ID1].code;
                                    var ID3 = ID2.toString();
                                    var ID4 = ID3.split('_');
            ...
            if (value == 'Splice Closure') {
                if (seg) {
                    ...
                    if (seg[0].spliceClosures == null) {
                        ...
                        var LastspliceClosureIndex = this.Data.length - 1;
                        var k = false;
                        if (this.SpliceClosureIncrementalID == 0) {
                            for (var i = 0; i <= 0; i++) {
                                for (var j = 0; j <= i; j++) {
                                    if (this.Data[i].segments[j].spliceClosures != undefined || this.Data[i].segments[j].spliceClosures != null) {
                                        var ID1 = this.Data[i].segments[j].spliceClosures.length - 1;
                                        var ID2 = this.Data[i].segments[j].spliceClosures[ID1].code;
                                        var ID3 = ID2.toString();
                                        var ID4 = ID3.split('_');
            ...
            if (value == 'odf') {
                ...
                if (seg) {
                    if (seg[0].odfs == null) {
                        ...
                        odf.code = 'ODF_' + Uid.substring(0, 4);
                        odf.name = odf.code;
                        odf.parentId = ent.id;
                        ...
                        if (this.OdfIncrementalID == 0) {
                            for (var i = 0; i <= 0; i++) {
                                for (var j = 0; j <= i; j++) {
                                    if (this.Data[i].segments[j].odfs != undefined || this.Data[i].segments[j].odfs != null) {
                                        var ID1 = this.Data[i].segments[j].odfs.length - 1;
                                        var ID2 = this.Data[i].segments[j].odfs[ID1].code;
                                        var ID3 = ID2.toString();
                                        var ID4 = ID3.split('_');
            ...
            for (var i = 0; i <= segments.length - 1; i++) {
                ...
                for (var j = 0; j <= i; j++) {
                    if (this.design.bluePrint.children[i].segments[j].cable != undefined) {
                        if (this.design.bluePrint.children[i].segments[j].cable.id == this.selectedEntity.id) {
                            ...
                            this.design.bluePrint.children.splice(i);
