...
let templateinfoComponent = class templateinfoComponent {
    constructor(route) {
        this.route = route;
...
templateinfoComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
...
let EntityList = class EntityList {
    constructor(cableService, chamberService, ductService, odfService, poleService, spliceClosureService, splitterService, homepassService, fatService, fdtService, helper) {
        this.cableService = cableService;
        this.chamberService = chamberService;
        this.ductService = ductService;
...
let FatDetails = class FatDetails {
    constructor(location, route, fatService, helper) {
        this.location = location;
        this.route = route;
        this.fatService = fatService;
        this.helper = helper;
    ...
    getFormData(fatId) {
        if (fatId != null) {
            $("#ajax-loading").show();
            this.fatService.getFAT(fatId).subscribe(resp => {
                this.fat = new _models_fat__WEBPACK_IMPORTED_MODULE_6__["FAT"]();
                if (resp.status.toLowerCase() == "error") {
                    this.helper.showAlertMessage(resp.message, "error");
                }
    ...
    save() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (this.fat.id == undefined) {
                var errorMessages = yield this.validateEntity(this.fat);
                if (errorMessages.length == 0) {
                    this.fatService.saveFAT(this.fat).subscribe(resp => {
                        if (resp.status.toLowerCase() == "error") {
                            this.helper.showAlertMessage(resp.message, "error");
                        }
                        else {
    ...
    validateEntity(fat) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (fat.name == null || fat.name.trim() == '')
                ...
                let resp = yield this.fatService.checkNameExists(fat.name);
                if (resp.message == 'false')
                    errorMessages.push("Name already exists.");
            }
            //    if (user.loginId == null || user.loginId.trim() == "")
...
let FdtDetails = class FdtDetails {
    constructor(location, route, fdtService, helper) {
        this.location = location;
        this.route = route;
        this.fdtService = fdtService;
        this.helper = helper;
    ...
    getFormData(fdtId) {
        if (fdtId != null) {
            $("#ajax-loading").show();
            this.fdtService.getFDT(fdtId).subscribe(resp => {
                this.fdt = new _models_fdt__WEBPACK_IMPORTED_MODULE_6__["FDT"]();
                if (resp.status.toLowerCase() == "error") {
                    this.helper.showAlertMessage(resp.message, "error");
                }
    ...
    save() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (this.fdt.id == undefined) {
                var errorMessages = yield this.validateEntity(this.fdt);
                if (errorMessages.length == 0) {
                    this.fdtService.saveFDT(this.fdt).subscribe(resp => {
                        if (resp.status.toLowerCase() == "error") {
                            this.helper.showAlertMessage(resp.message, "error");
                        }
                        else {
    ...
    validateEntity(fdt) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (fdt.name == null || fdt.name.trim() == '')
                ...
                let resp = yield this.fdtService.checkNameExists(fdt.name);
                if (resp.message == 'false')
                    errorMessages.push("Name already exists.");
            }
            //    if (user.loginId == null || user.loginId.trim() == "")
    ...
    validateEntity(homepass) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (homepass.name == null || homepass.name.trim() == '')
                ...
                let response = yield this.homepassService.checkNameExists(homepass.name);
